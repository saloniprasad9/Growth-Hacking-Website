          ...
          <div className='flex flex-col bg-green_gradient2 border-[1px] px-8 py-6 border-white rounded-[10px] w-[400px] h-[200px]'>
            <div className='flex flex-col'>
              <div className='flex flex-row space-x-4'>
                ...
                <div className='flex flex-col'>
                  <h2 className='text-white font-semibold'>Pratik Shigli (Vivan)</h2>
              ...
              <p className='text-[#c0c0c0] mt-2'>Got a new job at Vauld and started making videos for Coindcx.</p>
            </div>
          </div>
          <div className='flex flex-col bg-green_gradient2 border-[1px] px-8 py-6 border-white rounded-[10px] w-[400px] h-[300px]'>
            <div className='flex flex-col'>
              <div className='flex flex-row space-x-4'>
                ...
                <div className='flex flex-col'>
                  <h2 className='text-white font-semibold'>Ramya Anudeep</h2>
                  <p className='text-white'>Growth & Marketing Director</p>
              ...
              <p className='text-[#c0c0c0] mt-2'>Started with zero knowledge in marketing and with zero income. Now became a growth hacker and having an agency , served and serving 30+ clients from the past 11 months with a consistent income of 2 lakhs per month.</p>
            </div>
          </div>
        </div>
        <div className='flex flex-col space-y-10'>
          <div className='flex flex-col bg-green_gradient2 border-[1px] px-8 py-6 border-white rounded-[10px] w-[400px] h-[300px]'>
            <div className='flex flex-col'>
              <div className='flex flex-row space-x-4'>
                ...
                <div className='flex flex-col'>
                  <h2 className='text-white font-semibold'>Akhand Pratap Singh</h2>
              ...
              <p className='text-[#c0c0c0] mt-2'>When I mentioned the traffic growth on their website and few other things in start of the conversation the founder got ready to have next conversation with me. That resulted getting a full time job as a Product Manager even after being a fresher.</p>
            </div>
          </div>
          <div className='flex flex-col bg-green_gradient2 border-[1px] px-8 py-6 border-white rounded-[10px] w-[400px] h-[250px]'>
            <div className='flex flex-col'>
                <div className='flex flex-row space-x-4'>
                  ...
                  <div className='flex flex-col'>
                    <h2 className='text-white font-semibold'>Dr. Sushil Kumar</h2>
                    <p className='text-white'>Being in doctor</p>
                  </div>
                </div>
                <p className='text-[#c0c0c0] mt-2'>Being in doctor profession, I was totally unaware of the online customer journey. I learnt a lot. I have more clear vision regarding online training system</p>
              </div>
          </div>
        </div>
      </div>
      <button className='w-[120px] h-[50px] border-[#ddee36] text-white rounded-[6px] mt-20 border-[1px]'>Load more</button>
      <div className='flex justify-center items-center'>
